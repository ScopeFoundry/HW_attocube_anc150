...
class ScanningConfocalUI:
    ...
    def __init__(self):
        ...
        self.x_position.hardware_set_func = lambda x: self.nanodrive.set_pos_ax(x, MCL_AXIS_ID["X"])
        self.y_position.hardware_set_func = lambda y: self.nanodrive.set_pos_ax(y, MCL_AXIS_ID["Y"])
        self.z_position.hardware_set_func = lambda z: self.nanodrive.set_pos_ax(z, MCL_AXIS_ID["Z"])
    ...
    def on_scan_stop(self):
        ...
        save_params = ["h0", "h1", "v0", "v1",
                       "Nh", "Nv", 
                       "h_array", "v_array",
                       "dh", "dv", "count_rate_map", "pixel_time"]
        save_dict = dict()
