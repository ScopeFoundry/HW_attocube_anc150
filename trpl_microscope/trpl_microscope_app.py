...
from hardware_components.picoharp import PicoHarpHW
...
from hardware_components.flip_mirror import FlipMirrorHW
...
from hardware_components.shutter_servo_arduino import ShutterServoHW
...
class TRPLMicroscopeApp(BaseMicroscopeApp):
    ...
    def setup(self):
        ...
        self.picoharp_hc = self.add_hardware_component(PicoHarpHW(self))
        ...
        self.flip_mirror_hc = self.add_hardware_component(FlipMirrorHW(self))
        self.thorlabs_powermeter_hc = self.add_hardware_component(ThorlabsPowerMeterHW(self))
        ...
        self.power_wheel_arduino_hc = self.add_hardware_component(PowerWheelArduinoHW(self))    
        ...
        self.shutter_servo_hc = self.add_hardware_component(ShutterServoHW(self))
