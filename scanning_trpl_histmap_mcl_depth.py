...
class ScanningTRPLHistMapApp(wx.App):
    ...
    def OnInit(self):
        ...
        try:
            self.frame.m_staticText_maxdim.SetLabel("max: x %g x z %g um" % (self.nanodrive.cal_Y, self.nanodrive.cal_Z) )
        ...
        self.x_position.hardware_set_func = lambda x: self.nanodrive.set_pos_ax(x, YAXIS)
        self.y_position.hardware_set_func = lambda y: self.nanodrive.set_pos_ax(y, ZAXIS)
    ...
    def read_from_hardware(self):
        ...
        y, self.xpos, self.ypos = self.nanodrive.get_pos()
